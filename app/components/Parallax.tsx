    ...
    return (
        <div>
            ...
            <div className="py-24 bg-gray-200 text-center">
                ...
                <p className="mt-4">Tenemos varios paquetes, solo elije el que mas se adacte a ti.</p>
            ...
            >
                ...
                <div className="absolute inset-0 flex justify-center items-center text-white text-center z-10">
                    <div>
                        <h1 className="text-4xl md:text-6xl font-bold">Servicio de barberia</h1>
                        <p className="mt-4 text-lg md:text-xl">Cortes Profesionales para niños, adolecentes y adultos</p>
                    </div>
                </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
                ...
                <div className="py-24 bg-gray-200 text-center rounded-lg shadow-lg">
                    ...
                    <p className="mt-4">Costo $50.00 MXN en nuestro local.</p>
                </div>
                <div className="py-24 bg-gray-200 text-center rounded-lg shadow-lg">
